...
const Maintain = () => {
  return (
    <section class="bg-white dark:bg-gray-900 h-4/6	">
    <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <p class="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">Our ChatBot, WhatsGPT currently experiencing technical issues and are undergoing maintenance.We apologize for any inconvenience caused and appreciate your patience as we work to resolve the problem.</p>
